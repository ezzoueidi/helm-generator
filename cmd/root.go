...
// rootCmd represents the helm-generator when called without any subcommands
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".helm-generator" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".helm-generator")
	}
